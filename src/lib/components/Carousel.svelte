...
import { setupTweenParallax, addDotBtnsAndClickHandlers, addPrevNextBtnsClickHandlers } from '../carousel-helpers/carousel-helpers.js'
...
<header>
  <h1 class="header">Embla Carousel Parallax Vanilla</h1>
</header>
...
<footer class="footer">
  <a class="footer__link" href="https://github.com/davidjerleke/embla-carousel">
    <svg
